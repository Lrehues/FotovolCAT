...
SOURCES = \
	__init__.py \
	photovol_analysis.py photovol_analysis_dialog.py

PLUGINNAME = photovol_analysis

PY_FILES = \
	__init__.py \
	photovol_analysis.py photovol_analysis_dialog.py

UI_FILES = photovol_analysis_dialog_base.ui
...
QGISDIR=C:\Users\lluc2\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
